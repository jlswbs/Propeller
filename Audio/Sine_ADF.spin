'' Additive oscillator 6x with feedback
...
VAR
  ...
  long param[7], const, rand, freq[6], i, feedback
...
loop
              ...
              rdlong    freq_5, addr
              add       addr, #4
              rdlong    fb_shift, addr

              mov       temp_fb, feedback_val
              sar       temp_fb, fb_shift
              ...
              add       sine_index0, temp_fb
              add       sine_index1, temp_fb
              add       sine_index2, temp_fb
              add       sine_index3, temp_fb
              add       sine_index4, temp_fb
              add       sine_index5, temp_fb
              ...
              mov       feedback_val, combined_sample
